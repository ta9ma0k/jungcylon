...
export const Terminal = () => {
  ...
  return (
    <div className="bg-black h-full pt-5 px-15 flex">
      <div className="mt-15  w-2/6">
        <h3 className="text-6xl text-lime-500 text-center">{secondsToString(seconds)}</h3>
        <div className="flex justify-center">
          <Cube cube={cube} moveArea={guideArea}/>
        </div>
      </div>
      <div className="xl:text-xl text-lime-500 w-4/6">
        ...
        {progress === 100 && (
          <>
            <span className="xl:text-xl text-lime-500 mr-4">{'>'}</span>
            <input
              className="w-10/12 bg-black xl:text-xl text-lime-500 caret-lime-500 focus:outline-0 tracking-widest"
              value={command}
